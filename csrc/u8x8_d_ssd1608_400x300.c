/*
  ...
  u8x8_d_ssd1608_400x300.c

  SSD1608x2: 400x300 HINK_E042A01_A1
  command 
    0x22: assign actions
...
static const uint8_t u8x8_d_ssd1608_400x300_init_seq[] = {
    U8X8_START_TRANSFER(),
...
static const uint8_t u8x8_d_ssd1608_400x300_powersave0_seq[] = {
    U8X8_START_TRANSFER(),
    U8X8_CA(0x22, 0xc0),
    U8X8_C(0x20),
    U8X8_END_TRANSFER(),
...
static const uint8_t u8x8_d_ssd1608_400x300_powersave1_seq[] = {
    U8X8_START_TRANSFER(),
    U8X8_CA(0x22, 0x02),
    U8X8_C(0x20),
    U8X8_END_TRANSFER(),
...
static const uint8_t u8x8_d_ssd1608_to_refresh_seq[] = {
  U8X8_START_TRANSFER(),
  U8X8_CA(0x22, 0x04),
  U8X8_C(0x20),
  U8X8_END_TRANSFER(),
...
uint8_t u8x8_d_ssd1608_400x300(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
    ...
    case U8X8_MSG_DISPLAY_INIT:
        ...
        u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1608_400x300_init_seq);
        u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1608_400x300_powersave0_seq);
        break;
    ...
    case U8X8_MSG_DISPLAY_SET_POWER_SAVE:
        if (arg_int == 0)
            ...
            u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1608_400x300_powersave1_seq);
        break;
    ...
    case U8X8_MSG_DISPLAY_DRAW_TILE:
        /* Does NOT support u8x8_ClearDisplay function. */
        u8x8_d_ssd1608_draw_tile(u8x8, arg_int, arg_ptr);
        break;

    case U8X8_MSG_DISPLAY_REFRESH:
        u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1608_to_refresh_seq);
        break;
